...
| 상태 | 체크인 시간 | 계산식 |
|------|------------|--------|
| 정상 | 06:50:00 ~ 07:50:00 | `allowFrom(시작-70분)` ~ `normalThreshold(시작-10분)` |
| 지각 | 07:50:01 ~ 10:00:00 | `normalThreshold` 초과 ~ `meetingEnd` |
...
- `normalThreshold = meetingStart - 10분` (정상/지각 경계 — 07:50)
